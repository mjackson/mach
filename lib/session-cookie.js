...
function sessionCookie(app, options) {
  ...
  if (!secret) {
    console.warn([
      'No secret option provided to mach.sessionCookie! This poses a security',
      'vulnerability. It is strongly recommended that you set a session secret',
      'to prevent exploits that may be possible from carefully crafted cookies.'
    ].join('\n'));
  }
