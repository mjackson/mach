...
function Request(options) {
  ...
  this.content = new BufferedStream(Request.maxBufferSize, options.content || '');
  this.content.pause();
...
/**
 * The maximum size of the input buffer for incoming requests.
 */
 ...
 * and `content`.
 *
 * Note: The `content` will always be a readable Stream of data.
 */
