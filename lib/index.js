 ...
 * because it has open persistent connections) it is forecefully stopped
 * when the process exits. The default value is 0, meaning that servers shut
 * down immediately by default.
 *
 * Note: When increasing this value, be careful not to exceed any hard timeouts
 * specified by your PaaS. For example, on Heroku the dyno manager will not
 * permit a grace period longer than ten seconds.
