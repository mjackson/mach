...
/**
 * A helper for constructing a JSON (application/json) response for the
 * properties contained in the given object.
 *
 *   function (request) {
 ...
 */
mach.json = sendJson;
function sendJson(object, status, headers) {
  headers = headers || {};
  headers['Content-Type'] = 'application/json';
  var json = (typeof object === 'string') ? object : JSON.stringify(object);
  return mach.send(json, status, headers);
}
