...
describe('mach.forward', function () {
  describe('when no test function is given', function () {
    beforeEach(function () {
      return callApp(mach.forward(ok, target));
    });
  ...
  describe('a request that passes the test function', function () {
    beforeEach(function () {
      return callApp(mach.forward(ok, target, returnTrue));
    });
  ...
  describe('a request whose URL matches the test RegExp', function () {
    beforeEach(function () {
      return callApp(mach.forward(ok, target, /\/test-match$/), '/test-match');
    });
  ...
  describe('a request that does not pass the test function', function () {
    beforeEach(function () {
      return callApp(mach.forward(ok, target, returnFalse));
    });
